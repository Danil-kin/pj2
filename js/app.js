        ...
        function bgParallax() {
            ...
            if (bgItems.length) document.addEventListener("windowScroll", (function(e) {
                bgItems.forEach((bgItem => {
                    ...
                    let bgItemPositionValue = bgItemHeight / 100 * 20 / 100 * bgItemScrollPrc;
...
***************************************************************************** */
        ...
        window.addEventListener("load", (function(e) {
            if (document.querySelector(".dishes__body")) {
                const dishImg = document.querySelectorAll(".item-dish__image-ibg");
                const dishArrow = document.querySelectorAll(".item-dish__arrow");
                dishImg.forEach((element => {
                    element.addEventListener("mouseenter", (function(e) {
                        const prnt = e.target.closest(".item-dish");
                        prnt.classList.add("item-hover");
                    }));
                }));
                dishImg.forEach((element => {
                    element.addEventListener("mouseleave", (function(e) {
                        const prnt = e.target.closest(".item-dish");
                        prnt.classList.remove("item-hover");
                    }));
                }));
                dishArrow.forEach((element => {
                    element.addEventListener("mouseenter", (function(e) {
                        const prnt = e.target.closest(".item-dish");
                        prnt.classList.add("item-hover");
                    }));
            ...
            if (document.querySelector(".chefs__items")) {
                const chefImg = document.querySelectorAll(".chefs__image");
                const chefName = document.querySelectorAll(".chefs__title");
                chefImg.forEach((element => {
                    element.addEventListener("mouseenter", (function(e) {
                        const prnt = e.target.closest(".chefs__body");
                        prnt.classList.add("item-hover");
                    }));
                }));
                chefImg.forEach((element => {
            ...
            if (document.querySelector(".recipes__columns")) {
                ...
                const colRec = document.querySelectorAll(".column-recipes");
                const colRecIt = document.querySelectorAll(".item-column-recipes");
                colRec.forEach((element => {
                    element.addEventListener("mouseenter", (function(e) {
                        const prnt = e.target.closest(".column-recipes");
                        prnt.classList.add("item-hover");
                    }));
                }));
                colRec.forEach((element => {
                ...
                colRecIt.forEach((element => {
                    element.addEventListener("mouseenter", (function(e) {
                        const prnt = e.target.closest(".column-recipes__item");
                        prnt.classList.add("item-hover");
                    }));
                }));
                colRecIt.forEach((element => {
            ...
            if (document.querySelector(".body-item-social")) {
                const socImg = document.querySelectorAll(".body-item-social__box");
                socImg.forEach((element => {
                    element.addEventListener("mouseover", (function(e) {
                        const prnt = e.target.closest(".body-item-social__box");
                        prnt.classList.add("item-hover");
                    }));
                }));
                socImg.forEach((element => {
            ...
            if (document.querySelector(".item-social__head-box")) {
                const followBtn = document.querySelectorAll(".item-social__button");
                followBtn.forEach((element => {
                    element.addEventListener("mouseenter", (function(e) {
                        const prnt = e.target.closest(".item-social__head-box");
                        prnt.classList.add("item-hover");
                    }));
                }));
                followBtn.forEach((element => {
